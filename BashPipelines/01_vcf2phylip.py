...
# On Euler, make sure to have python/2.7 loaded and to not have python3 loaded as well
...
# Function to write the lines in phylip format	
...
parser.add_argument('-n', '--noAmb', action='store_true', help="if -n is specified, no ambiguous codes are used but instead one allele is chosen", default=False)
